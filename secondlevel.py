...
class card:
    def __init__(self, type):
        ...
        switch = {
            1: r"C:\Users\roche\Desktop\GAME\Matching Pair\Second Level\CINAMMON.png",
            2: r"C:\Users\roche\Desktop\GAME\Matching Pair\Second Level\OREGANO.png",
            3: r"C:\Users\roche\Desktop\GAME\Matching Pair\Second Level\PARSLEY.png",
            4: r"C:\Users\roche\Desktop\GAME\Matching Pair\Second Level\PEPPER.png",
            5: r"C:\Users\roche\Desktop\GAME\Matching Pair\Second Level\SALT.png",
            6: r"C:\Users\roche\Desktop\GAME\Matching Pair\Second Level\SOY SAUCE.png",
            7: r"C:\Users\roche\Desktop\GAME\Matching Pair\Second Level\SUGAR.png",
            8: r"C:\Users\roche\Desktop\GAME\Matching Pair\Second Level\VANILLA.png",
...
class Memory_Game(App):
    ...
    def build(self):
        self.amount_of_cards = 6
        self.flipped_cards = [0, 0]  # Holds the index of the two flipped cards.
        self.display_list = [GridLayout(cols=3) for i in range(self.amount_of_cards * 2)]
        self.outcome = []
        ...
        self.window.cols = 3
        self.window.padding = (15,50,15,50)
        self.window.spacing = (15,50)
        self.button_list = []
